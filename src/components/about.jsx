            ...
            <div className="grid md:grid-cols-12 grid-cols-1 items-center gap-6 relative">
                ...
                <div className="md:col-span-7">
                    <div className="lg:ms-8">
                        <h3 className="mb-6 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">Best Travelling <br></br>Experiences</h3>

                        <p className="text-slate-400 max-w-xl mb-6">Embark on unforgettable journeys filled with stunning landscapes, vibrant cultures, and immersive adventures. Discover hidden gems, indulge in local delicacies, and create cherished memories that will last a lifetime. Your ultimate travel story begins here!</p>
                        <br></br>
                        <Link to="/contact" className="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-red-500 text-white rounded-md">Join With Us <i className="mdi mdi-chevron-right align-middle ms-0.5"></i></Link>
                    </div>
                </div>
