        ...
        <div className="lg:col-span-4 md:col-span-6">
          <div className="sticky top-20">
            ...
            <div className="text-center mt-8">
              ...
              <p className="text-slate-400">Tour Specialist</p>
            </div>
            ...
            <ul className="list-none text-center mt-8 space-x-3">
              {blogSocial.map((item, index) => {
                let Icon = item.icon;
                return (
                  <li className="inline" key={index}>
                    <Link
                      to={item.link}
                      target="_blank"
                      className="size-8 inline-flex items-center justify-center tracking-wide align-middle text-base border border-gray-300 dark:border-slate-800 rounded-md hover:bg-red-500 hover:text-white text-slate-300"
                    >
                      <Icon
