    ...
    return(
        <div className="container relative">
            <div className="grid grid-cols-1 pb-8 text-center">
                <h3 className="mb-2 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">Most Popular Attractions</h3>
                                ...
                                <div className="tiny-slide" key={index}>
                                    <div className="group relative overflow-hidden rounded-md shadow dark:shadow-gray-800 m-2">
                                        ...
                                        <div className="absolute p-4 bottom-0 start-0">
                                            <Link to={`/tour-detail-one/${item.id}`} className="text-lg font-medium text-white hover:text-red-500 duration-500 ease-in-out">{item.place}</Link>
