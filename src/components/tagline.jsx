                        ...
                        <ul className="list-none">
                            ...
                            <li className="inline-flex items-center ms-2">
                                <ul className="list-none space-x-3">
                                    ...
                                    <li className="inline-flex ms-2 mb-0"><a href='https://wa.me/+94776102001' className="text-slate-300 hover:text-red-500"><FiPhone className="size-4 align-middle" title="phone"></FiPhone></a></li>
                                </ul>
                            </li>
                        </ul>
                    </div>
