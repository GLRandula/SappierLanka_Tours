                ...
                <ul className="py-2 text-start">
                  ...
                  <li>
                    <Link
                      ...
                      className="flex items-center font-medium py-2 px-4 dark:text-white/70 hover:text-red-500 dark:hover:text-white"
                    >
                      <FiSettings className="size-4 me-2"></FiSettings>
                      Settings
                    </Link>
                  </li>
        ...
        >
          <ul className={`navigation-menu ${manuclass}`}>
            {/* <li className={`has-submenu parent-menu-item ${['/','/index-two','/index-three','/index-four','/index-five','/index-item'].includes(manu) ? 'active' : '' }`}>
                            <Link to="" onClick={()=>setSubManu(setManu === '/index-item' ? '' : '/index-item')}>Home</Link><span className="menu-arrow"></span>
