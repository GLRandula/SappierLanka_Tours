                            ...
                            <div className="grid md:grid-cols-12 grid-cols-1 gap-6">
                                ...
                                <div className="lg:col-span-3 md:col-span-4">
                                    <div className="lg:ms-8">
                                        ...
                                        <h5 className="tracking-[1px] text-gray-100 mt-6">SappierLanka Tours</h5>
                                        ...
                                        <div className="flex mt-4">
                                            ...
                                            <div className="">
                                                <Link to='https://wa.me/+94776102001' className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out">+94 77-610-2001</Link>
                                            </div>
                                        </div>
                                        <div className="flex">
                                            <FiPhone className="size-4 text-red-500 me-2 mt-1"></FiPhone>
                                            <div className="">
                                                <Link to='https://wa.me/+94757732001' className="text-slate-300 hover:text-slate-400 duration-500 ease-in-out">+94 75-773-2001</Link>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div className="container relative text-center">
                    <div className="grid grid-cols-1">
                        <div className="text-center">
                            <p className="mb-0">© {new Date().getFullYear()} SappierLanka Tours. Design & Develop with <i className="mdi mdi-heart text-red-600"></i> by <Link to="www.linkedin.com/in/glrandula" target="_blank" className="text-reset text-red-300">Lakith Randula</Link></p>
                        </div>
                    </div>
                </div>
            </div>
