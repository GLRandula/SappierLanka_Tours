...
export default function Client(){
    ...
    return(
        ...
        <div className="grid grid-cols-1 pb-6 text-center">
            <h3 className="mb-2 md:text-3xl text-2xl md:leading-normal leading-normal font-semibold">What Our Customers Say</h3>

            <p className="text-slate-400 max-w-xl mx-auto">Hear from our satisfied customers about their remarkable experiences and seamless travel arrangements.</p>
        </div>
