              ...
              <div className="flex flex-col min-h-screen justify-center md:px-10 py-10 px-4">
                ...
                <div className="title-heading text-center my-auto">
                  ...
                  <p className="text-white/70 text-lg max-w-xl mx-auto">
                    Start working with Travosy that can provide everything you
                ...
                <div className="text-center">
                  <p className="mb-0">
                    © {new Date().getFullYear()} SappierLanka Tours. Design &
                    Develop with <i className="mdi mdi-heart text-red-600"></i>{" "}
                    by{" "}
                    <Link
                      to="www.linkedin.com/in/glrandula"
                      target="_blank"
                      className="text-reset text-red-300"
                    >
                      Lakith Randula
                    </Link>
                  </p>
