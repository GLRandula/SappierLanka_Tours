...
import { FiCamera, FiChevronUp, FiMapPin, FiTag } from '../../../assets/icons/vander';
          ...
          <div className="container relative">
            <div className="grid md:grid-cols-12 grid-cols-1 gap-6">
              <div className="lg:col-span-8 md:col-span-7">
                ...
                <p className="flex items-center text-red-500 text-xl font-semibold mt-2">
                <FiTag  className="size-4 me-1" />{" "}
                  Price: {data.price}
                </p>

                <div className="mt-6">
                  <h5 className="text-lg font-semibold">Tour Descriptions:</h5>
                  <p className="text-slate-400 mt-6">{data?.description}</p>
                </div>
                <div className="mt-6">
                  <h5 className="text-lg font-semibold">Attractions: </h5>
                ...
                <div className="mt-6">
                  ...
                  <p className="text-slate-400 mt-2">{data?.sub_places}</p>
                </div>
                {/* Days */}
                <div className="mt-6">
                  <h5 className="text-lg font-semibold">Duration:</h5>
                  <p className="text-slate-400 mt-2">{data?.days} Tour</p>
                </div>

                {/* Items */}
                <div className="mt-6">
                  <h5 className="text-lg font-semibold">Other Items:</h5>
                  ...
                  <div className="mt-6">
                    ...
                    <a href="https://wa.me/+94776102001">
                      <button
                        ...
                        id="submit"
                        name="send"
                        className="py-2 px-5 inline-block tracking-wide align-middle duration-500 text-base text-center bg-red-500 text-white rounded-md w-48 mt-10"
                      >
                        Book Now
                      </button>
                    </a>
